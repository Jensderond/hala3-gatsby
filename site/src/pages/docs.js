...
const DocsPage = ({ data }) => {
  return (
    <Container>
      <SEO
        title="Docs"
        description="Documentation for Gatsby Theme Rotterdam"
      />
      <Content>
        <h1>Docs</h1>
        <h3>Gatsby Theme Rotterdam</h3>
        <p>
        ...
        <p>
          <iframe
            title="github"
            src="https://ghbtns.com/github-btn.html?user=jensderond&repo=gatsby-theme-rotterdam&type=star&count=true&size=large"
            frameBorder="0"
            scrolling="0"
            width="160px"
            height="30px"
        ...
        <h3>
          Use{' '}
          <a
            href="https://github.com/jensderond/gatsby-starter-rotterdam"
            target="_blank"
            rel="noopener noreferrer"
          >
            Gatsby Starter Rotterdam
          </a>
        </h3>
        <p>
        ...
        <div className="gatsby-highlight" data-language="text">
          <pre className="language-text">
            <code className="language-text">
              ...
              https://github.com/jensderond/gatsby-starter-rotterdam
            </code>
          </pre>
        </div>
            ...
            <pre className="language-javascript">
              <code className="language-javascript">
                ...
                <span className="token template-string">
                  <span className="token string">'gatsby-theme-rotterdam'</span>
                </span>
                <span className="token punctuation">,</span>
                <br />
          ...
          <pre className="language-javascript">
            <code className="language-javascript">
              <span className="token comment">
                ...
                'src/gatsby-theme-rotterdam/styles/theme.js'
              </span>
              <br />
