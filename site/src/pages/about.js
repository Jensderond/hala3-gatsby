...
const AboutPage = ({ data }) => {
  return (
    <Container>
      <SEO title="About" description="About Gatsby Theme Rotterdam" />
      <Content>
        <h1>About</h1>
        <p>
          <img
        ...
        <p>
          <strong>Gatsby Theme Rotterdam</strong> was designed to be a minimal
        ...
        <p>
          ...
          <strong>
            <a
              href="https://twitter.com/Jensderond"
              target="_blank"
              rel="noopener noreferrer"
            >
              Jens de Rond
